      ...
      <div className="p-4 mt-36 flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center text-center">
          <p className="font-bold text-[24px]">
            COLLECTIVE FARMING: The Future of Agriculture Upstream
          </p>
          <p className="font-bold text-[18px] text-[#55A840]">
            Penanganan krisis dan pengembangan &nbsp;
            <span className="font-normal">industri hulu pertanian</span>
          </p>
        </div>
        <div
          className="
        ...
        <div className="flex flex-col justify-center items-center text-center">
          <p className="font-bold text-xl lg:text-[24px]">
            On-Farm Management & Collective Farming
          </p>
          <p className="text-md lg:text-[18px]">
            Manajemen lahan hamparan, terpadu, serempak dan penerapan GAP (Good
        ...
        <hr className="w-5/12 h-[3px] bg-[#55A840] my-10 lg:my-28" />
        <div className="flex flex-col justify-center items-center text-center">
          <p className="font-bold text-lg lg:text-[24px]">
            Collective Farming: The Effective Approach
          </p>
          <p className="text-md lg:text-[18px]">
            Pendekatan “manajemen lahan terkonsolidasi” jauh lebih efektif untuk
            meningkatkan produksi dan mencegah kegagalan panen
          </p>
        </div>
        <div className="mb-28 mt-10">
          <img
            className="object-scale-down rounded-lg w-[1082px] mt-10 h-[600px]"
            src={table}
            alt="Table"
          />
        </div>
