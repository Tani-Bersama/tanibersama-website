  ...
  return (
    <>
      <div className="max-h-[70px] w-full flex flex-row justify-between items-center bg-white font-all top-0 sticky">
        ...
        <div
          className={`mr-14 lmd:ml-14 lmd:static absolute lmd:bg-transparent bg-white lmd:min-h-fit min-h-[40vh] left-0 top-[${margin}] lmd:w-auto w-full flex items-center justify-center px-5`}
        >
        ...
        <div
          ...
          onClick={() => {
            clicked ? setMargin("-5000%") : setMargin("70px");
            setClicked(!clicked);
          }}
        >
          {clicked ? (
