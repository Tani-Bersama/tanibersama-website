    ...
    <Layout>
        ...
        <div className="flex justify-center">
            ...
            <Items
                ...
                description="Lahan serentak satu hamparan, 
                        satu manajemen budidya"
            />
            <Items title="Teknologi IoT, aplikasi dan pendukung budidaya" />
            <Items title="Survey, perencanaan dan penjadwalan budidaya" />
            <Items
                title="Pembiayaan Hamparan"
                description="Semua mendapatkan pembiayaan"
            />
            <Items
            ...
            />
            <Items
                title="Konsolidasi subkontraktor"
                description="Kualitas, dukungan dan kapasitasnya meningkat"
            />
            <Items
                title="On-farm management"
                description="Manajemen budidaya modern, terpadu dan terintegrrasi"
            />
            <Items
                title="Konsolidasi supplier dan vendor 
